...
# Filter out additional 19 Ss with too positive attitudes in "disliked music" condition (reported ratings above 3) & too negative attitudes in "liked music" condition (reported ratings below 3):
...
#### (3.2.1) A quick check of N by gender in data.
...
#### (3.2.2) Code for logistical regressions.
...
```
Note that the `echo = FALSE` parameter was added to the code chunk to prevent printing of the R code that generated the figures. Further, the 'eval = FALSE' parameter was added to the top code chunk to prevent printing of the code along with any generated figures
